...
# Criação do Nó
docker run -dit --name no1 -v /var/www/html:/usr/share/nginx/html -v /home/davi/configLB:/etc/nginx/conf.d -v /home/davi/configNginx/nginx.conf:/etc/nginx/nginx.conf nginx:1.29.3-alpine
```
